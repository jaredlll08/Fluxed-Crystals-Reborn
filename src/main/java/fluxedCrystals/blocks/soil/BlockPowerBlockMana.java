...
public class BlockPowerBlockMana extends Block implements ITileEntityProvider, IPowerSoil {

	public BlockPowerBlockMana() {

		super(Material.grass);
		this.setHardness(1.0F);
		this.setHarvestLevel("shovel", 1);
		this.setBlockTextureName(Textures.Blocks.POWEREDSOILMANA);
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityPowerBlockMana();
	}

	public void onBlockPreDestroy(World world, int x, int y, int z, int meta) {
		TileEntityPowerBlockMana tile = (TileEntityPowerBlockMana) world.getTileEntity(x, y, z);
		if (tile != null) {
