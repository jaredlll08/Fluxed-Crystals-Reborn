...
/**
 * The class contains helper functions related to Holidays! The holidays
 * intentionally begin a day before the actual holiday and end one day after it.
 *
...
public class HolidayHelper {
	...
	public static boolean isBirthdayJared(){
		setDate(holidayStart, Calendar.JUNE, 28, false);
		setDate(holidayEnd, Calendar.JUNE, 30, false);
	...
	public static boolean isEaster() {
		...
		/*
		 * Compute the day of the year that Easter falls on. Step names E1 E2
		 * etc., are direct references to Knuth, Vol 1, p 155.
		 * 
		 * http://en.wikipedia.org/wiki/Computus#Meeus.2FJones.2F
		 * Butcher_Gregorian_algorithm
		 */
		Calendar easterSun;
		...
		century = (year / 100) + 1; /*
									 * Centuries are shifted by one e.g. 1984
									 * was in 20th C
									 */
