...
public class SeedData implements INBTTaggable, JsonSerializer<SeedData>, JsonDeserializer<SeedData> {
	...
	public SeedData(String name, int color, int dropMin, int dropMax, int growthTime, int tier, int ingredientAmount, int powerPerStage, int weightedDropChance, int refinerAmount, int entityID, boolean decorationBlocks, String ingredient, String weightedDrop) {
	...
	public SeedData(String name, int color, int dropMin, int dropMax, int growthTime, int tier, int ingredientAmount, int powerPerStage, int weightedDropChance, int refinerAmount, int entityID, boolean decorationBlocks, String ingredient, String weightedDrop, String lore) {
