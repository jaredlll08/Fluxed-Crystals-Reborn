...
public class ItemCrystalAxe extends ItemAxe {
	...
	public ItemCrystalAxe() {
		...
		setUnlocalizedName(Reference.LOWERCASE_MOD_ID + "." + Names.Items.CRYSTAL_AXE);
	}
	...
	public void registerIcons(IIconRegister icon) {
		...
		icons = new IIcon[2];
		icons[0] = icon.registerIcon(Reference.MOD_ID + ":shardAxeRod");
		icons[1] = icon.registerIcon(Reference.MOD_ID + ":shardAxeHead");
	}
